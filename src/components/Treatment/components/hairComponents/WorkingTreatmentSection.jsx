...
const stepsData = [
    {
        ...
        description: "Share your hair loss photos for AI analysis and personalized recommendations",
        icon: SmartToy,
    ...
    },
    {
        ...
        description: "Get detailed hair loss assessment and treatment recommendations",
    ...
    },
    {
        ...
        description: "Surgeon selection, procedure booking, travel and accommodation",
        icon: CalendarToday,
    ...
    },
    {
        ...
        description: "Fly in, get your procedure, and return with new hair growth",
        icon: Flight,
        gradient: 'linear-gradient(to right, #f97316, #ef4444)',
        bgGradient: 'linear-gradient(to bottom right, #fff7ed, #fee2e2)',
    },
];
                ...
                <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 10 }}>
                    <Box textAlign="center" mb={10}>
                        ...
                        <Typography variant="h4" color="text.secondary" sx={{ maxWidth: 'lg', mx: 'auto' }}>
                            AI-powered planning for seamless hair restoration experience
                        </Typography>
                    </Box>
