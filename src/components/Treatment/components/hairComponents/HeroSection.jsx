                ...
                <Grid container spacing={8} alignItems="center">
                    ...
                    <Grid item xs={12} md={6}>
                        <Box>
                            <Chip
                                icon={<AutoAwesome />}
                                label="AI-Powered Hair Restoration"
                            ...
                            <Typography variant="h6" color="primary.main" sx={{ display: 'flex', alignItems: 'center', gap: 1, my: 2 }}>
                                <SmartToyOutlined />
                                AI-Planned Hair Restoration Journey
                            </Typography>
                            <Typography variant="body1" color="text.secondary" sx={{ maxWidth: '500px', mb: 4 }}>
                                From FUE to FUT techniques — get personalized hair restoration plans, world-class surgeons, and complete travel support for natural-looking results.
                            </Typography>
