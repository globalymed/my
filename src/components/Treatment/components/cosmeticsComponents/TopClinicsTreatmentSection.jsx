...
const clinicsData = [
    {
        ...
        image: "https://placehold.co/400x300/e9d5ff/5b21b6?text=Fortis+La+Femme",
        rating: 4.9,
        gradient: "linear-gradient(to right, #9333ea, #3b82f6)",
        gradientOverlay: "linear-gradient(to bottom right, #9333ea, #3b82f6)",
    },
    {
        name: "Apollo Cosmetic Surgery",
        location: "Chennai, Bangalore, Hyderabad",
        accreditation: ["JCI", "NABH"],
        image: "https://placehold.co/400x300/dbeafe/1e40af?text=Apollo+Cosmetic",
        rating: 4.8,
        gradient: "linear-gradient(to right, #3b82f6, #06b6d4)",
        gradientOverlay: "linear-gradient(to bottom right, #3b82f6, #06b6d4)",
    },
    {
        name: "Max Healthcare Aesthetics",
        location: "Delhi, Gurgaon, Noida",
        accreditation: ["NABH", "JCI"],
        image: "https://placehold.co/400x300/ecfdf5/15803d?text=Max+Aesthetics",
        rating: 4.7,
    ...
    },
    {
        ...
        accreditation: ["JCI", "NABH"],
        image: "https://placehold.co/400x300/fce7f3/9d174d?text=Kokilaben+Hospital",
        rating: 4.8,
        gradient: "linear-gradient(to right, #ec4899, #f43f5e)",
        gradientOverlay: "linear-gradient(to bottom right, #ec4899, #f43f5e)",
    },
    {
        name: "Medanta Aesthetics",
        location: "Gurgaon, Lucknow",
        accreditation: ["NABH", "JCI"],
        image: "https://placehold.co/400x300/ffedd5/c2410c?text=Medanta+Aesthetics",
        rating: 4.6,
    ...
    },
    {
        ...
        accreditation: ["JCI", "NABH"],
        image: "https://placehold.co/400x300/ccfbf1/0d9488?text=BLK+Cosmetic",
        rating: 4.7,
            ...
            <Container maxWidth="xl">
                ...
                <Box textAlign="center" mb={10}>
                    ...
                    <Typography variant="h4" color="text.secondary" sx={{ maxWidth: 'lg', mx: 'auto' }}>
                        Leading aesthetic centers with board-certified surgeons and international standards
                    </Typography>
                </Box>
