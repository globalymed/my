...
const transformationsData = [
    {
        ...
        patient: "Sarah M., USA",
        before: "https://placehold.co/400x300/e9d5ff/3730a3?text=Before+Rhinoplasty",
        after: "https://placehold.co/400x300/c7d2fe/312e81?text=After+Rhinoplasty",
        gradient: "linear-gradient(to right, #9333ea, #4f46e5)",
    },
    {
        treatment: "Breast Augmentation",
        patient: "Emma K., UK",
        before: "https://placehold.co/400x300/fce7f3/9d174d?text=Before+Breast+Aug",
        after: "https://placehold.co/400x300/fbcfe8/831843?text=After+Breast+Aug",
        gradient: "linear-gradient(to right, #ec4899, #f43f5e)",
    },
    {
        treatment: "Liposuction",
        patient: "Maria R., Spain",
        before: "https://placehold.co/400x300/dbeafe/1e3a8a?text=Before+Liposuction",
        after: "https://placehold.co/400x300/a5f3fc/0e7490?text=After+Liposuction",
            ...
            <Container maxWidth="xl">
                ...
                <Box textAlign="center" mb={10}>
                    ...
                    <Typography variant="h4" color="text.secondary" sx={{ maxWidth: 'lg', mx: 'auto' }}>
                        See the incredible cosmetic surgery results our patients have achieved
                    </Typography>
                </Box>
