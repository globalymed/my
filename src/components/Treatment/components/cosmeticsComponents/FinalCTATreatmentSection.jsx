            ...
            <Container maxWidth="md" sx={{ textAlign: 'center', position: 'relative', zIndex: 1, color: 'white' }}>
                ...
                <Box sx={{ mb: 6 }}>
                    <Chip
                        ...
                        label="Transform Your Look Today"
                        sx={{
                            mb: 3,
                            color: 'white',
                            fontWeight: 'medium',
                    ...
                    <Typography variant="h4" sx={{ mb: 6, color: 'rgba(255, 255, 255, 0.9)', maxWidth: 'lg', mx: 'auto' }}>
                        Join thousands of satisfied patients who chose India for world-class cosmetic surgery at unbeatable prices.
                    </Typography>
                </Box>
