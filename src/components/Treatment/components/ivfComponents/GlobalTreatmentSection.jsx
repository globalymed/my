...
const benefits = [
    {
        Icon: Award,
        title: "Leading Fertility Specialists",
        description: "Board-certified reproductive endocrinologists with international training",
    ...
    },
    {
        ...
        description: "High-quality treatment at fraction of US/European prices",
    ...
    },
    {
        ...
        description: "Latest IVF labs, time-lapse imaging, and genetic testing",
    ...
    },
    {
        ...
        description: "Immediate treatment start with flexible scheduling",
    ...
    },
    {
        ...
        description: "Medical tourism packages with accommodation and care",
        iconGradient: "linear-gradient(to right, #fb923c, #ef4444)",
        bgColor: "#fff7ed",
    },
];
...
const costItems = [
    { procedure: "IVF Cycle", india: "$2,500-$4,000", abroad: "$12,000-$20,000", savings: "75%" },
    { procedure: "ICSI Treatment", india: "$3,000-$4,500", abroad: "$15,000-$25,000", savings: "78%" },
    { procedure: "Egg Donation IVF", india: "$3,500-$5,000", abroad: "$20,000-$35,000", savings: "82%" },
    { procedure: "Surrogacy Package", india: "$8,000-$12,000", abroad: "$50,000-$80,000", savings: "83%" },
        ...
        <Box component="section" sx={{ py: { xs: 8, md: 12 }, px: 2, position: 'relative', overflow: 'hidden' }}>
            ...
            <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 1, px: { lg: 12, xs: 0 }, }}>
                ...
                <Box sx={{ textAlign: 'center', mb: { xs: 8, md: 10 } }}>
                    <Chip
                        icon={<GlobeIcon />}
                        label="Global Fertility Destination"
                        sx={{
                            mb: 3,
                            color: '#15803d',
                            borderRadius: 3,
                    ...
                    <Typography variant="h3" component="h2" fontWeight="bold" sx={{ mb: 2, fontSize: "3rem" }}>
                        ...
                        <Typography component="span" variant="inherit" sx={{
                            ...
                            India for IVF Treatment?
                        </Typography>
                    </Typography>
                    <Typography variant="h4" color="text.secondary" sx={{ maxWidth: 'md', mx: 'auto' }}>
                        World-class fertility specialists and advanced technology at affordable prices
                    </Typography>
                </Box>
                                ...
                                <Box key={index} sx={{ display: 'flex', alignItems: 'flex-start', gap: 3, }}>
                                    ...
                                    <Box>
                                        <Typography variant="h6"
                                            fontWeight="bold"
                                            sx={{
                                                mb: 1, transition: 'color 0.3s ease',
                                                '&:hover': {
                                                    color: '#db2777'
                                                }
                                            }}>
