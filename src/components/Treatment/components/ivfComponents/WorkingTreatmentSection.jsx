...
import { SmartToy, CheckCircleOutline, CalendarToday, AutoAwesome, ChildCare, } from '@mui/icons-material';
...
const stepsData = [
    {
        ...
        description: "Upload fertility reports and medical history for AI analysis",
        icon: SmartToy,
        gradient: 'linear-gradient(to right, #ec4899, #f43f5e)',
        bgGradient: 'linear-gradient(to bottom right, #fdf2f8, #fff1f2)',
    },
    {
        step: "2",
        title: "AI Treatment Plan",
        description: "Get personalized treatment recommendations and clinic options",
    ...
    },
    {
        ...
        description: "Specialist selection, treatment scheduling, travel arrangements",
        icon: CalendarToday,
        gradient: 'linear-gradient(to right, #a855f7, #6366f1)',
        bgGradient: 'linear-gradient(to bottom right, #faf5ff, #eef2ff)',
    },
    {
        step: "4",
        title: "Fertility Treatment",
        description: "Receive world-class treatment and return home with hope",
        icon: ChildCare,
                ...
                <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 10 }}>
                    <Box textAlign="center" mb={10}>
                        ...
                        <Typography variant="h4" color="text.secondary" sx={{ maxWidth: 'lg', mx: 'auto' }}>
                            AI-powered planning for seamless fertility treatment experience
                        </Typography>
                    </Box>
