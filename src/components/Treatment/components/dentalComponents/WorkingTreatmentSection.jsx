...
const stepsData = [
    {
        ...
        description: "Share your dental concerns or upload X-rays for AI analysis",
        icon: SmartToy,
    ...
    },
    {
        ...
        description: "Get curated clinic options, treatments, and cost estimates",
    ...
    },
    {
        ...
        description: "Virtual consults, appointments, travel & accommodation booking",
        icon: CalendarToday,
    ...
    },
    {
        ...
        description: "Fly in, get treated by experts, and return home healthy",
        icon: Flight,
                ...
                <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 10 }}>
                    <Box textAlign="center" mb={10}>
                        ...
                        <Typography variant="h4" color="text.secondary" sx={{ maxWidth: 'lg', mx: 'auto' }}>
                            AI-powered planning for a seamless cosmetic surgery experience
                        </Typography>
                    </Box>
