                ...
                <Grid container spacing={8} alignItems="center">
                    ...
                    <Grid item xs={12} md={6}>
                        <Box>
                            <Chip
                                icon={<AutoAwesome />}
                                label="AI-Powered Treatment Planning"
                            ...
                            <Typography variant="h6" color="primary.main" sx={{ display: 'flex', alignItems: 'center', gap: 1, my: 2 }}>
                                <SmartToyOutlined />
                                Planned by AI. Trusted by Patients.
                            </Typography>
                            <Typography variant="body1" color="text.secondary" sx={{ maxWidth: '500px', mb: 4 }}>
                                From cosmetic makeovers to critical oral surgeries — get curated treatment options, top hospitals, and full travel support in one place.
                            </Typography>
